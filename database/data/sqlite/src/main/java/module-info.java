...
module net.anwiba.database.sqlite {
  exports net.anwiba.database.sqlite.connection;
  exports net.anwiba.database.sqlite;
  exports net.anwiba.database.sqlite.utilities;
  exports net.anwiba.database.sqlite.column;
