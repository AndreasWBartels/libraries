...
import net.anwiba.tools.icons.schema.configuration.Icon;
import net.anwiba.tools.icons.schema.configuration.IconSize;
import net.anwiba.tools.icons.schema.configuration.IconSizes;
import net.anwiba.tools.icons.schema.configuration.Icons;
...
public class GuiIconConfigurationsReader {
  ...
  public void add(final File file) throws IOException {
    try {
      final JAXBContext jc = JAXBContext.newInstance(
          net.anwiba.tools.icons.schema.configuration.ObjectFactory.class.getPackageName(),
  ...
  public void add(final URL url) throws IOException {
    try {
      final JAXBContext jc = JAXBContext.newInstance(
          net.anwiba.tools.icons.schema.configuration.Icons.class,
          net.anwiba.tools.icons.schema.configuration.Class.class,
          net.anwiba.tools.icons.schema.configuration.IconSizes.class,
          net.anwiba.tools.icons.schema.configuration.IconSize.class,
          net.anwiba.tools.icons.schema.configuration.Icon.class);
      final Unmarshaller u = jc.createUnmarshaller();
  ...
  public void add(
    ...
    for (final Icon icon : iconsList) {
      ...
      if (icon.getImage() != null && icon.getClazz() == null && parentFolder != null) {
        if (!this.imageExistsValidator
            .exists(concat(parentFolder, iconsPackageName), iconSizesConfiguration, icon.getImage())) {
  ...
  private String concat(final String parentFolder, final String iconsPackageName) {
    return parentFolder + "/" + iconsPackageName.replaceAll("\\.", "/") + "/icons";
  }
