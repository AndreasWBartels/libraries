...
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_BOOLEAN;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_BYTE;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_CHARACTER;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_DOUBLE;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_FLOAT;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_INTEGER;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_LONG;
import static net.anwiba.tools.generator.java.bean.JavaConstants.JAVA_LANG_SHORT;
...
import static net.anwiba.tools.generator.java.bean.JavaConstants.resevedNames;
...
public class SourceFactoryUtilities {
  ...
  public static String createFieldName(final String name) {
    return resevedNames.contains(name)
        ? MessageFormat.format("_{0}", name)
        : specialNames.containsKey(name)
  ...
  public static void adjust(
    ...
    final String typeName = field.type().isArray()
    ...
    if (value != null) {
      ...
      for (final C i : values) {
        newArray
            .add(
                (field.type().isArray()
                    ? field.type().elementType().isPrimitive()
