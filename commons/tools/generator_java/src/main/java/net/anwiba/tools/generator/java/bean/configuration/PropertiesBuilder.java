...
public class PropertiesBuilder {
  ...
  public void fieldComment(final String fieldComment) {
    this.fieldComment = fieldComment;
  }

  public void setterComment(final String setterComment) {
    this.setterComment = setterComment;
  }

  public void getterComment(final String getterComment) {
