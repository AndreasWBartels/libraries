...
public final class RandomObjectGenerator {
  ...
  public Color generateColor(final boolean hasAlpha) {
    if (hasAlpha) {
      return new Color(generateInteger(255), generateInteger(255), generateInteger(255), generateInteger(255));
    }
    return new Color(generateInteger(255), generateInteger(255), generateInteger(255));
  }
}