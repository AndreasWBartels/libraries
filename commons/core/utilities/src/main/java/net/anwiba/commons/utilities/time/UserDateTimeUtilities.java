...
public class UserDateTimeUtilities {
  ...
  public static IZonedDateTimeRange asZoneDateTimeRange(final LocalDateTimeSegment userDateTimeSegment) {
    if (userDateTimeSegment == null) {
      return null;
    }
    ZonedDateTime time = asZoneDateTime(userDateTimeSegment.getTime());
    return new ZonedDateTimeRange(
        time,
        time.plus(userDateTimeSegment.getDuration(), userDateTimeSegment.getTimeUnit().toTemporalUnit()));
  }
  ...
  public static String toString(final LocalDateTime dateTime) {
    return dateTime
        .atZone(ZonedDateTimeUtilities.getUserZone())
        .format(
  ...
  public static Date toDate(final LocalDateTime dateTime) {
    return Date.from(dateTime.toInstant(ZoneOffset.from(asZoneDateTime(dateTime))));
  }
