...
public class ByteUtilities {
  ...
  public static int getIntegerLittleEndian(final byte[] destination, final int pos) {
    return getInteger(destination, pos, ByteOrder.LITTLE_ENDIAN);
  }

  public static int getIntegerBigEndian(final byte[] destination, final int pos) {
  ...
  public static short getShortLittleEndian(final byte[] destination, final int pos) {
  ...
  public static int setIntegerLittleEndian(final int value, final byte[] destination, final int pos) {
    return setInteger(value, destination, pos, ByteOrder.LITTLE_ENDIAN);
  }

  public static int setIntegerBigEndian(final int value, final byte[] destination, final int pos) {
  ...
  public static double getDoubleBigEndian(final byte[] destination, final int pos) {
    return getDouble(destination, pos, ByteOrder.BIG_ENDIAN);
  }

  public static double getDoubleLittleEndian(final byte[] destination, final int pos) {
  ...
  public static int setDoubleBigEndian(final double value, final byte[] destination, final int pos) {
    return setDouble(value, destination, pos, ByteOrder.BIG_ENDIAN);
  }

  public static int setDoubleLittleEndian(final double value, final byte[] destination, final int pos) {
  ...
  public static float getFloatBigEndian(final byte[] destination, final int pos) {
    return getFloat(destination, pos, ByteOrder.BIG_ENDIAN);
  }

  public static float getFloatLittleEndian(final byte[] destination, final int pos) {
  ...
  public static int setFloatBigEndian(final float value, final byte[] destination, final int pos) {
    return setDouble(value, destination, pos, ByteOrder.BIG_ENDIAN);
  }

  public static int setFloatLittleEndian(final float value, final byte[] destination, final int pos) {
    return setDouble(value, destination, pos, ByteOrder.LITTLE_ENDIAN);
  }
