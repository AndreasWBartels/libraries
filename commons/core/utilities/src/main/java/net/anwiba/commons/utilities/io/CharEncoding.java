...
public enum CharEncoding implements ICharEncoding {
  ...
  private CharEncoding(final byte code, final String key, final String keyLangApi) {
    this.code = code;
    this.key = key;
  ...
  public static ICharEncoding getByCode(final byte code) {
    for (final CharEncoding type : values()) {
  ...
  public static ICharEncoding getByName(final String name) {
    for (final CharEncoding type : values()) {
