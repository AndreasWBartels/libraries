...
public class AbstractApplicableRegistry<I, O extends IApplicable<I>> extends ObjectCollection<O>
    implements
    IApplicableRegistry<I, O> {

  O defaultFactory;

  public AbstractApplicableRegistry(final O defaultApplicable) {
    this.defaultFactory = defaultApplicable;
  }

  public boolean isApplicable(final I context) {
    return Streams.of(this).filter(factory -> factory.isApplicable(context)).first().isAccepted();
  }
