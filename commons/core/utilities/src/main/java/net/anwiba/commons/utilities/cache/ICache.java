...
public interface ICache {
  ...
  IResourceReference add(Object key, byte[] data, String mimeType, String encoding);

  IResourceReference add(Object key, byte[] data, String mimeType, String encoding, long lifeTime);
