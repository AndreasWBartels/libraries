...
public class CountingIterableIterable<I, O, E extends Exception> implements IIterable<O, E> {

  private final IIterable<I, E> input;
  private final IAcceptor<I> acceptor;
  private final IAggregator<Integer, I, O, E> aggegator;

  public CountingIterableIterable(
  ...
  public IIterator<O, E> iterator() {
    return new CountingIteratorIterator<>(this.input.iterator(), this.acceptor, this.aggegator);
  }
