...
public final class IterableFlattingIterable<I, O, E extends Exception> implements IIterable<O, E> {

  private final IIterable<I, E> input;
  private final IAcceptor<I> acceptor;
  private final IConverter<I, Iterable<O>, E> converter;

  public IterableFlattingIterable(
  ...
  public IIterator<O, E> iterator() {
    return new IteratorFlattingIterator<>(this.input.iterator(), this.acceptor, this.converter);
  }
}
