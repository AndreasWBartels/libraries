...
public class ResourceUtilities {
  ...
  public static InputStream getInputStream(final Class clazz, final String resourceUrl) {
    return clazz.getResourceAsStream(toRelativePathIfNot(clazz, resourceUrl));
  }
  ...
  private static String toRelativePathIfNot(final Class clazz, final String resourceUrl) {
    ...
    final Path resourcePath = Paths.get(withoutRootSlash(resourceUrl)).normalize();
  ...
  private static String withoutRootSlash(final String resourceUrl) {
