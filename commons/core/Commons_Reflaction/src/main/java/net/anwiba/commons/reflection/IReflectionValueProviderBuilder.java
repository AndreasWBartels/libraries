...
public interface IReflectionValueProviderBuilder {
  ...
  public abstract <T> IReflectionValueProviderBuilder set(Class<T> clazz, Class<? extends T> objectClass);

  public abstract <T> IReflectionValueProviderBuilder add(Class<T> clazz, Class<? extends T> objectClass);

  public abstract <T> IReflectionValueProviderBuilder set(Class<T> clazz, IInjectingFactory<T> objectFactory);

  public abstract <T> IReflectionValueProviderBuilder add(Class<T> clazz, IInjectingFactory<T> objectFactory);

  public abstract <T> IReflectionValueProviderBuilder link(Class<T> clazz, Class<? extends T> link);

  public abstract IReflectionValueProvider build() throws CreationException;
