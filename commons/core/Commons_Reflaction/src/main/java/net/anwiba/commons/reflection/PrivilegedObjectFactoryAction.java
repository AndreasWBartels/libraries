...
final class PrivilegedObjectFactoryAction<C> extends AbstractPrivilegedAction<C> {
  private final Object[] arguments;
  private final Class<? extends C> clazz;
  private final Class<?>[] argumentTypes;

  PrivilegedObjectFactoryAction(final Class<? extends C> clazz, final Class<?>[] argumentTypes, final Object[] arguments) {
