...
public final class EmptyReflectionValueProvider implements IReflectionValueProvider {

  private final HashMap<Class, List<Object>> values = new HashMap<>();

  public EmptyReflectionValueProvider() {
    this(new HashMap<Class, List<Object>>());
  }

  private EmptyReflectionValueProvider(final HashMap<Class, List<Object>> values) {
