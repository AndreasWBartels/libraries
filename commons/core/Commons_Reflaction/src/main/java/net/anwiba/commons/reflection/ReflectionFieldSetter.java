...
public class ReflectionFieldSetter {
  ...
  public ReflectionFieldSetter(final Object object) {
    this.object = object;
  }

  public void invoke(final String fieldName, final Object value) throws InvocationTargetException {
    this.invoker.invoke(new PrivilegedFieldSetterAction(this.object, fieldName, value));
  }
}
