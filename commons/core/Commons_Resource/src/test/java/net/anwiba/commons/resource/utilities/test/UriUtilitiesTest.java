...
public class UriUtilitiesTest {
  ...
  public void testGetParentUri() throws Exception {
    ...
    assertThat(
        UriUtilities.getParentUri(new URI("http://localhost/jgisshell/config/script-module-configuration.xml")), equalTo(new URI("http://localhost/jgisshell/config"))); //$NON-NLS-1$ //$NON-NLS-2$
