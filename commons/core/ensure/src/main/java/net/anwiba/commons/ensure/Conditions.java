...
public class Conditions {
  ...
  public static <T extends Comparable<T>> ICondition<T> greaterEquals(final T value) {
    Ensure.ensureArgumentNotNull(value);
  ...
  @SafeVarargs
  public static <T> ICondition<T> anyOf(final ICondition<T>... conditions) {
    return new AnyOfCondition<>(Arrays.stream(conditions).collect(toList()));
  }

  @SafeVarargs
  public static <T> ICondition<T> allOf(final ICondition<T>... conditions) {
    return new AllOfCondition<>(Arrays.stream(conditions).collect(toList()));
  }
