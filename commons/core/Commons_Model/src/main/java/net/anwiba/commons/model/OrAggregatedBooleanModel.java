...
public class OrAggregatedBooleanModel extends AbstractObjectChangedNotifier implements IBooleanModel {

  private final IBooleanModel model;

  public OrAggregatedBooleanModel(final Collection<IBooleanModel> models) {
