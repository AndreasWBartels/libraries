...
public final class PreferencesDialogAction extends AbstractAction {
  ...
  public void actionPerformed(final ActionEvent e) {
    ...
    final IFunction<IPreferenceNode, Boolean, RuntimeException> storeFunction = new IFunction<>() {
  ...
  public void show(
    ...
    final IContentPaneFactory contentPaneFactory = (owner, node, d) -> new AbstractContentPane(d) {
