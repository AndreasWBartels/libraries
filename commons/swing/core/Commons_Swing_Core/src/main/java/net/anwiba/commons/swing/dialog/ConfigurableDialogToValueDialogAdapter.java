...
public final class ConfigurableDialogToValueDialogAdapter<T> implements IValueDialog<T> {
  ...
  public ConfigurableDialogToValueDialogAdapter(final ConfigurableDialog dialog, final IObjectModel<T> model) {
    this.dialog = dialog;
    this.model = model;
  }
  ...
  @Override
  public void setVisible(final boolean is) {
    this.dialog.setVisible(is);
  }
