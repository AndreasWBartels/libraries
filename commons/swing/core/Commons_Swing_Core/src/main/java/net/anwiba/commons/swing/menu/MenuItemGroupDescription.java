...
public class MenuItemGroupDescription extends AbstractActionGroupDescription {
  ...
  public MenuItemGroupDescription(final String id, final int weight) {
    this(id, weight, false);
  }

  public MenuItemGroupDescription(final String id, final int weight, final boolean isToggelGroup) {
  ...
  public boolean equals(final Object obj) {
    ...
    final MenuItemGroupDescription other = (MenuItemGroupDescription) obj;
