...
public class MenuMenuItemDescription extends AbstractMenuItemDescription {

  public MenuMenuItemDescription(final MenuDescription menuDescription, final int weight) {
    this(menuDescription, new MenuItemGroupDescription("DEFAULT", 0), weight); //$NON-NLS-1$
  }

  public MenuMenuItemDescription(
