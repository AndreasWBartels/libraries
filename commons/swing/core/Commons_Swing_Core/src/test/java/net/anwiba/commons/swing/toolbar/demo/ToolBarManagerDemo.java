...
public class ToolBarManagerDemo extends SwingDemoCase {
  ...
  public void demo() {
    ...
    final ToolBarItemGroupDescription toolBarToggelGroupDescription = new ToolBarItemGroupDescription(
        "toolbargroup", 1, true); //$NON-NLS-1$
    toolBarManager.add(new ToolBarItemConfiguration(
    ...
    toolBarManager.add(new ToolBarItemConfiguration(new ToolBarItemDescription(
        toolBarDescription0,
        toolBarGroupDescription,
        1), new EmptyAction(null, GuiIcons.ERROR_ICON.getSmallIcon())));
    final ToolBarDescription toolBarDescription1 = new ToolBarDescription("toolbar1", 0, true); //$NON-NLS-1$
    toolBarManager.add(createToolBarItemConfiguration(
  ...
  private ToolBarItemConfiguration createToolBarItemConfiguration(
    ...
    return new ToolBarItemConfiguration(new ToolBarItemDescription(
        toolBarDescription1,
        toolBarToggelGroupDescription,
        4), new EmptyAction(null, smallIcon));
  }
  ...
  private ToolBarItemConfiguration getToolBarItemConfiguration() {
    ...
    final ComboBoxModel<Double> comboBoxModel = new DefaultComboBoxModel<>(new Double[]{
        Double.valueOf(1.1),
        Double.valueOf(1.25),
        Double.valueOf(1.5),
        Double.valueOf(1.75),
    ...
    final JComboBoxActionProvider actionContainerProvider = new JComboBoxActionProvider(comboBoxModel, action, "Test"); //$NON-NLS-1$
    ...
    final ToolBarItemConfiguration toolBarItemConfiguration = new ToolBarItemConfiguration(new ToolBarItemDescription(
        toolBarDescription2,
        4), actionContainerProvider, action);
