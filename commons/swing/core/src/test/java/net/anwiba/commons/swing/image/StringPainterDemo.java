...
public class StringPainterDemo {
  ...
  public void show(final String fontName, final int distance) {
    final RenderingHints hints = new RenderingHintsBuilder()
    ...
    final IChangeableObjectListener listener = () -> Optional.of(factorModel.get())
        .consume(
            f -> Optional.of(imageSizeModel.get())
                .consume(
    ...
    JFrames.show(Duration.ofSeconds(10), panel);
  }
