...
public class ViewDemo {
  ...
  public void demo() {
    ...
    final AbstractMenuItemConfiguration<? extends AbstractMenuItemDescription>[] menuItemConfigurations =
        new MenuActionItemConfiguration[] { new MenuActionItemConfiguration(
            new MenuActionItemDescription(new MenuDescription("fileId", //$NON-NLS-1$
                "File", //$NON-NLS-1$
                0), 0),
    ...
    final ToolBarItemConfiguration[] toolBarItemConfigurations =
        new ToolBarItemConfiguration[] { new ToolBarItemConfiguration(
