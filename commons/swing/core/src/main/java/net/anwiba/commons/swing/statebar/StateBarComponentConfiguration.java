...
public class StateBarComponentConfiguration {
  ...
  public StateBarComponentConfiguration(
    final StateBarComponentDescription stateBarComponentDescription,
    final IStateBarComponent stateBarComponent) {
    Ensure.ensureArgumentNotNull(stateBarComponentDescription);
    Ensure.ensureArgumentNotNull(stateBarComponent);
    this.stateBarComponent = stateBarComponent;
