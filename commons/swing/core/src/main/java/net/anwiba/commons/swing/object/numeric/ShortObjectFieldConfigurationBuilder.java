...
public class ShortObjectFieldConfigurationBuilder
    extends
    AbstractObjectFieldConfigurationBuilder<Short, ShortObjectFieldConfigurationBuilder> {
  ...
  public ShortObjectFieldConfigurationBuilder() {
    super(new IValidator<String>() {
      ...
      @Override
      public Short convert(final String number) {
      ...
      @Override
      public String convert(final Short number) {
        if (number == null) {
          return null;
        }
