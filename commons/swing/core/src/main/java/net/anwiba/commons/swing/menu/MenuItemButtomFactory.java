...
public final class MenuItemButtomFactory implements IMenuItemTypeVisitor<AbstractButton> {
  ...
  public MenuItemButtomFactory(final JMenu menu, final AbstractMenuItemConfiguration<?> menuItemConfiguration) {
    this.menu = menu;
  ...
  public AbstractButton visitAction() {
    ...
    if (this.menuItemConfiguration instanceof PopupMenuActionItemConfiguration) {
      final PopupMenuActionItemConfiguration menuActionItemConfiguration = (PopupMenuActionItemConfiguration) this.menuItemConfiguration;
      if (menuActionItemConfiguration.hasActionContainerProvider()) {
        final IActionContainerProvider<? extends Container> actionContainerProvider = menuActionItemConfiguration
    ...
    final MenuActionItemConfiguration menuActionItemConfiguration = (MenuActionItemConfiguration) this.menuItemConfiguration;
    if (menuActionItemConfiguration.hasActionContainerProvider()) {
      final IActionContainerProvider<? extends Container> actionContainerProvider = menuActionItemConfiguration
          .getActionContainerProvider();
      this.menu.add(actionContainerProvider.getContainer());
