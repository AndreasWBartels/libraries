...
public class LocalDateTimeRangeFieldBuilder extends
    AbstractAlgebraicObjectFieldBuilder<ILocalDateTimeRange, LocalDateTimeRangeObjectFieldConfigurationBuilder,
        LocalDateTimeRangeFieldBuilder> {
  ...
  @Override
  protected AbstractObjectTextField<ILocalDateTimeRange> create(
      final IObjectFieldConfiguration<ILocalDateTimeRange> configuration) {
    return new LocalDateTimeRangeField(configuration);
  }

  // public LocalDateTimeRangeFieldBuilder addSliderActions(
