...
public class ZonedDateTimeFieldBuilder extends
    AbstractAlgebraicObjectFieldBuilder<ZonedDateTime, ZonedDateTimeObjectFieldConfigurationBuilder,
        ZonedDateTimeFieldBuilder> {
  ...
  @Override
  protected AbstractObjectTextField<ZonedDateTime> create(
      final IObjectFieldConfiguration<ZonedDateTime> configuration) {
    return new ZonedDateTimeField(configuration);
  }

  public ZonedDateTimeFieldBuilder addSliderActions(
      final ZonedDateTime minimum,
      final ZonedDateTime maximum,
      final long step,
    ...
    final Function<ZonedDateTime, ZonedDateTime> add = input -> Optional.of(input).convert(v1 -> {
    ...
    final Function<ZonedDateTime, ZonedDateTime> minus = input -> Optional.of(input).convert(v1 -> {
    ...
    final Function<ZonedDateTime, Boolean> minusEnabler = input -> Optional
        .of(input)
    ...
    final Function<ZonedDateTime, Boolean> addEnabler = input -> Optional
        .of(input)
