...
public class ConfigurableDialogLauncher implements IDialogLauncher {
  ...
  private static net.anwiba.commons.logging.ILogger logger =
      net.anwiba.commons.logging.Logging.getLogger(ConfigurableDialogLauncher.class);
  ...
  public ConfigurableDialogLauncher setOkButtonText(final String string) {
    this.dialogConfigurationBuilder.setActionButtonTextFactory(s -> {
      return s.equals(DialogMessages.OK)
          ? string
          : s;
    });
    return this;
  ...
  public IDialogResult launch(final Window owner) {
    ...
    GuiUtilities.invokeAndWait(() -> {
      try {
        ...
        final ProgressDialogLauncher<ConfigurableDialog, RuntimeException> progressDialogLauncher =
