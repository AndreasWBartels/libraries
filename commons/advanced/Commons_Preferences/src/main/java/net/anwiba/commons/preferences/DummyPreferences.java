...
public final class DummyPreferences implements IPreferences {
  ...
  public void setInt(final String key, final int value) {
    this.preferences.put(key, Integer.valueOf(value));
  }

  @Override
  public void setDouble(final String key, final double value) {
    this.preferences.put(key, Double.valueOf(value));
  }

  @Override
  public boolean getBoolean(final String key, final boolean defaultValue) {
    if (this.preferences.containsKey(key)) {
      final Object object = this.preferences.get(key);
      return object == null
          ? defaultValue
          : Boolean.valueOf(ObjectUtilities.toString(object)).booleanValue();
    }
    return defaultValue;
  }
  ...
  public void setBoolean(final String key, final boolean value) {
    this.preferences.put(key, Boolean.valueOf(value));
  }
  ...
  public IPreferences node(final String... nodes) {
    ...
    if (!this.children.containsKey(nodes[0])) {
      this.children.put(nodes[0], new DummyPreferences(ArrayUtilities.concat(String.class, this.path, nodes[0])));
    }
    final IPreferences preferences = this.children.get(nodes[0]);
    if (nodes.length > 1) {
  ...
  public int getInt(final String key, final int defaultValue) {
    if (this.preferences.containsKey(key)) {
      ...
      return object == null
          ? defaultValue
          : Integer.valueOf(ObjectUtilities.toString(object)).intValue();
    }
    return defaultValue;
  }
  ...
  public double getDouble(final String key, final double defaultValue) {
    if (this.preferences.containsKey(key)) {
      ...
      return object == null
          ? defaultValue
          : Double.valueOf(ObjectUtilities.toString(object)).doubleValue();
    }
    return defaultValue;
  }
  ...
  public String get(final String key, final String defaultValue) {
    if (this.preferences.containsKey(key)) {
      ...
      return object == null
          ? defaultValue
          : ObjectUtilities.toString(object);
    }
    return defaultValue;
  }
  ...
  public Iterable<String> keys() {
    final ArrayList<String> keys = new ArrayList<>(this.preferences.keySet());
    Collections.sort(keys);
    return keys;
  }
