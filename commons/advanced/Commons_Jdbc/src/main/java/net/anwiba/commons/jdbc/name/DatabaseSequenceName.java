...
public class DatabaseSequenceName implements IDatabaseSequenceName {
  ...
  public DatabaseSequenceName(final String schemaName, final String sequenceName) {
    this(null, schemaName, sequenceName);
  }

  public DatabaseSequenceName(final String tableName) {
    this(null, null, tableName);
  }

  public DatabaseSequenceName(final String catalogName, final String schemaName, final String sequenceName) {
  ...
  public int hashCode() {
    ...
    return prime * result + ((this.sequenceName == null) ? 0 : this.sequenceName.hashCode());
  }
