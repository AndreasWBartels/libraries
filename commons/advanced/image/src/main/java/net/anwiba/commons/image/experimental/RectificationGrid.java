...
public class RectificationGrid {
  ...
  public RectificationGrid(final int width, final int height) {
    this.width = width;
    this.height = height;
  ...
  public static RectificationGrid createRectangular(final int imgWidth,
      final int imgHeight,
      final int xStep,
      final int yStep) {
  ...
  public static RectificationGrid createTestGrid(final int imgWidth,
      final int imgHeight,
      final int xStep,
      final int yStep) {
