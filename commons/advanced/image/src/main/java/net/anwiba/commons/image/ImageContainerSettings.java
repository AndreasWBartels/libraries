...
public class ImageContainerSettings implements IImageContainerSettings {
  ...
  private ImageContainerSettings() {
    this((message, throwable, messageType) -> {});
  }

  private ImageContainerSettings(final IImageContainerListener imageContainerListener) {
    this.imageContainerListener = imageContainerListener;
  }
  ...
  @Override
  public IImageContainerSettings adapt(final IImageContainerListener listener) {
    return new ImageContainerSettings(listener);
  }
