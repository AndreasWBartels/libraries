...
public class DatabaseViewName implements IDatabaseViewName {
  ...
  public DatabaseViewName(final String schemaName, final String tableName) {
    this(null, schemaName, tableName);
  }

  public DatabaseViewName(final String viewName) {
    this(null, null, viewName);
  }

  public DatabaseViewName(final String catalogName, final String schemaName, final String tableName) {
  ...
  public boolean equals(final Object obj) {
    ...
    return obj instanceof IDatabaseViewName other
