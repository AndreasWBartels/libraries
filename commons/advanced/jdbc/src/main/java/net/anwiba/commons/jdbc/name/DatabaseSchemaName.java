...
public class DatabaseSchemaName implements IDatabaseSchemaName {

  private final String catalogName;
  private final String schemaName;

  public DatabaseSchemaName(final String schemaName) {
    this(null, schemaName);
  }

  public DatabaseSchemaName(final String catalogName, final String schemaName) {
  ...
  public int hashCode() {
    ...
    return prime * result + ((this.schemaName == null) ? 0 : this.schemaName.hashCode());
  }
  ...
  public boolean equals(final Object obj) {
    ...
    return obj instanceof IDatabaseSchemaName other
