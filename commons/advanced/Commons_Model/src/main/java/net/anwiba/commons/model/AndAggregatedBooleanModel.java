...
public class AndAggregatedBooleanModel extends AbstractObjectChangedNotifier implements IBooleanModel {

  private final IBooleanModel model;

  public AndAggregatedBooleanModel(final Collection<IBooleanModel> models) {
