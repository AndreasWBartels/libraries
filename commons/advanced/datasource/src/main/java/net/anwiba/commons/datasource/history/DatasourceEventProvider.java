...
public class DatasourceEventProvider implements IDatasourceEventProvider {
  ...
  public DatasourceEventProvider(final IDatasourceEventStorage storage) {
    this.storage = storage;
  }

  @Override
  public IObjectList<IDatasourceEvent> getEvents(final IResourceDescription description) {
    return this.storage.read(description);
  }
