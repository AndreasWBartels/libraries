...
public abstract class AbstractHttpConnectionDescription extends AbstractConnectionDescription implements
  ...
  private String getQueryString() {
    ...
    final int indexOfQueryStartSymbol = this.path == null
        ? -1
        : this.path.indexOf("?");
  ...
  protected int createHashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((this.host == null)
        ? 0
        : this.host.toUpperCase().hashCode());
    result = prime * result + ((this.parameters == null)
        ? 0
        : this.parameters.hashCode());
    result = prime * result + ((this.password == null)
        ? 0
        : this.password.toUpperCase().hashCode());
    result = prime * result + ((this.path == null)
        ? 0
        : this.path.toUpperCase().hashCode());
    result = prime * result + this.port;
    result = prime * result + (this.sslEnabled
        ? 1231
        : 1237);
    result = prime * result + ((this.userName == null)
        ? 0
        : this.userName.toUpperCase().hashCode());
    return result;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    return Objects.equals(getDataSourceType(), other.getDataSourceType()) //
        ...
        && Objects.equals(getParameters(), other.getParameters()) && isSslEnabled() == other.isSslEnabled();
  }
