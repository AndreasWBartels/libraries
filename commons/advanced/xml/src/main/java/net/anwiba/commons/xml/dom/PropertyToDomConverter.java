...
public class PropertyToDomConverter implements IObjectToDomConverter<IProperty> {
  ...
  @Override
  public Element convert(final IProperty object) throws DomConverterException {
    return element("property").addAttribute("name", object.getName()).addAttribute("value", object.getValue()); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
  }
