...
public final class PropertiesBuilder {
  ...
  public PropertiesBuilder(final IProperties properties) {
    Streams.of(properties).foreach(p -> this.properties.put(p.getName(), p));
  }

  public PropertiesBuilder add(final String name, final Serializable value) {
    return add(new Property(name, value));
  }

  public PropertiesBuilder add(final IProperty parameter) {
    this.properties.put(parameter.getName(), parameter);
    return this;
  }
