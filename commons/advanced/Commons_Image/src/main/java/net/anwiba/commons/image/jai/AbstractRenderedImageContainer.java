...
public abstract class AbstractRenderedImageContainer implements IImageContainer {
  ...
  public IImageContainer crop(final float x, final float y, final float width, final float height) {
    final RenderedOp cropedRenderOp = JAIImageContainerUtilities.crop(this.image, x, y, width, height);
    final RenderedOp translateedRenderOp = JAIImageContainerUtilities.translate(cropedRenderOp, -x, -y);
  ...
  public IImageContainer scale(final float widthFactor, final float heightFactor) {
    final RenderedOp scaledRenderOp = JAIImageContainerUtilities.scale(this.image, widthFactor, heightFactor);
