...
public class DatasetTableFactory {
  ...
  private static net.anwiba.commons.logging.ILogger logger =
      net.anwiba.commons.logging.Logging.getLogger(DatasetTableFactory.class);
  ...
  ObjectListTable<Dataset> create(
      ...
      final IObjectModel<ISortOrder> sortOrderModel,
      final List<Dataset> datasets,
      final boolean isNavigationEnabled,
      final Consumer<IObjectTableBuilder<Dataset>> tableBuilderConsumer) {
    final IObjectTableBuilder<Dataset> builder = new ObjectTableBuilder<Dataset>()
        ...
        .addStringColumn(
            ...
            value -> value == null
                ? null
                : CkanUtilities.toString(value),
            40);

    if (isNavigationEnabled) {

      builder.setHeaderMouseListenerFactory(new IMouseListenerFactory<Dataset>() {
        ...
        public MouseListener create(
          ...
          return new MouseAdapter() {
            ...
            public void mouseClicked(final MouseEvent e) {
              ...
              final ObjectListTable<ObjectPair<Boolean, ISortOrderTerm>> table =
                  new ObjectTableBuilder<ObjectPair<Boolean, ISortOrderTerm>>()
                    ...
                    public IContentPanel create(
                      ...
                      return new AbstractContentPane(dataStateModel) {
                        ...
                        public JComponent getComponent() {
                          ...
                          table
                              .getTableModel()
                              .addListModelListener(new IChangeableListListener<ObjectPair<Boolean, ISortOrderTerm>>() {
                                @Override
            ...
            private IObjectListColumnConfiguration<ObjectPair<Boolean, ISortOrderTerm>> createOrderTypeColumn() {
              final ObjectComboBoxModel<Order> comboBoxComponentModel =
                  new ObjectComboBoxModel<>(Arrays.asList(Order.values()));
              ...
              final IObjectUi<Order> objectUi = new ObjectUiBuilder<Order>().icon(o -> {
                switch (o) {
                  case asc: {
                    return net.anwiba.commons.swing.icons.gnome.contrast.high.ContrastHightIcons.PAN_UP.getSmallIcon();
                  }
                  case desc: {
            ...
            private ISortOrder create(final IObjectIterable<ObjectPair<Boolean, ISortOrderTerm>> values) {
              final Collection<ISortOrderTerm> collection =
                  Streams.of(values).filter(v -> v.getFirstObject()).convert(v -> v.getSecondObject()).asCollection();
            ...
            private List<ObjectPair<Boolean, ISortOrderTerm>> getSortOrderTerms(
              ...
              final ISortOrderVisitor<List<ISortOrderTerm>, RuntimeException> visitor = new ISortOrderVisitor<>() {
    ...
    builder.addActionFactory((tableModel, selectionIndicesProvider, selectionModel, sortStateModel) -> {
      final BooleanModel enabledModel = new BooleanModel(false);
      selectionModel
      ...
      selectionModel
          .addSelectionListener(
              e -> enabledModel
                  .set(
                      Desktop.isDesktopSupported() && !e.getSource().isEmpty() && !StringUtilities
    ...
    tableBuilderConsumer.accept(builder);
