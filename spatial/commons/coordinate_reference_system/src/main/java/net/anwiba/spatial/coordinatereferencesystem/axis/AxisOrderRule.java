...
public enum AxisOrderRule {
  COORDINATEREFERENCESYSTEM {
    ...
    @Override
    public AxisOrder getAxisOrderByCoordinateReferenceSystemName(final String name) {
      return AxisOrder.COORDINATEREFERENCESYSTEM;
    }
  },
  COORDINATEREFERENCESYSTEM_SYNTAX {

    @Override
    public AxisOrder getAxisOrderByCoordinateReferenceSystemName(final String name) {
      if (Authority.isUrn(name)) {
        return AxisOrder.COORDINATEREFERENCESYSTEM;
      }
      return AxisOrder.XY;
    }
  ...
  public abstract AxisOrder getAxisOrderByCoordinateReferenceSystemName(String name);
}
