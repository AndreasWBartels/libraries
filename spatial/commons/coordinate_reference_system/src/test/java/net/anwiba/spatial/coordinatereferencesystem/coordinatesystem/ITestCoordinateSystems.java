...
import static net.anwiba.spatial.coordinatereferencesystem.coordinatesystem.ParameterName.FALSE_EASTING;
import static net.anwiba.spatial.coordinatereferencesystem.coordinatesystem.ParameterName.FALSE_NORTHING;
import static net.anwiba.spatial.coordinatereferencesystem.coordinatesystem.ParameterName.LATITUDE_OF_ORIGIN;
import static net.anwiba.spatial.coordinatereferencesystem.coordinatesystem.ParameterName.LONGITUDE_OF_ORIGIN;
import static net.anwiba.spatial.coordinatereferencesystem.coordinatesystem.ParameterName.SCALE_FACTOR;
...
public interface ITestCoordinateSystems {
  ...
  public static final ProjectedCoordinateSystem DHDN_soldner_Berlin = new ProjectedCoordinateSystem(
      ...
      GG_DHDN,
      new Projection(ProjectionType.CASSINI_SOLDNER,
  ...
  public static final ProjectedCoordinateSystem DHDN_GK_3 = new ProjectedCoordinateSystem(
      ...
      GG_DHDN,
      new Projection(ProjectionType.GAUSS_KRUGER,
          gk_z3_parameters),
      Unit.METER);
  ...
  public static final ProjectedCoordinateSystem WGS_84_UTM_32N = new ProjectedCoordinateSystem(
      ...
      "UTM_32", //$NON-NLS-1$
      GG_WGS_84,
      new Projection(ProjectionType.TRANSVERSE_MERCATOR,
          utm_32n_parameters),
      Unit.METER);
