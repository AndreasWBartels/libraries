...
public class SortOrderList implements ISortOrderList {
  ...
  public SortOrderList(final Collection<ISortOrderTerm> terms) {
    this.terms.addAll(terms);
  }

  @Override
  public <O, E extends Exception> O accept(final ISortOrderVisitor<O, E> visitor) throws E {
    return visitor.visitList(this.terms);
  }
