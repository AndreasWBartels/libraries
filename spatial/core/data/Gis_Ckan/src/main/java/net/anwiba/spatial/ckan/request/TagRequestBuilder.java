...
public class TagRequestBuilder {
  ...
  public static class TagListRequestBuilder {
    ...
    public IRequest build() {
      final RequestBuilder builder = RequestBuilder.get(MessageFormat.format("{0}/3/action/tag_list", this.url)); //$NON-NLS-1$
  ...
  public static class TagSearchRequestBuilder {
    ...
    public IRequest build() {
      final RequestBuilder builder = RequestBuilder
          .get(MessageFormat.format("{0}/3/action/tag_search", this.url)) //$NON-NLS-1$
