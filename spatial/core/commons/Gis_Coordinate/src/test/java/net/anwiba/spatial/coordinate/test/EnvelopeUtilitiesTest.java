...
public class EnvelopeUtilitiesTest {
  ...
  public void testCreateByCoordinateSequence() {
    ...
    assertEquals(
        ...
        EnvelopeUtilities.createEnvelope(this.coordinateSequenceFactory.create(new double[] { 10, 5 }, new double[] {
            5, 10 })));
    assertEquals(
        new Envelope(new double[] { 5, 5 }, new double[] { 10, 10 }, false),
        EnvelopeUtilities.createEnvelope(this.coordinateSequenceFactory.create(new double[] { 10, 5, 8 }, new double[] {
            5, 10, 8 })));
  }
  ...
  public void testConcat() throws Exception {
    ...
    assertEquals(new Envelope(new double[] { 5, 5 }, new double[] { 10, 10 }, false), EnvelopeUtilities.concat(
        new Envelope(new double[] { 5, 5 }, new double[] { 10, 10 }, false),
        Envelope.NULL_ENVELOPE));
    assertEquals(new Envelope(new double[] { 5, 5 }, new double[] { 10, 10 }, false), EnvelopeUtilities.concat(
        Envelope.NULL_ENVELOPE,
        new Envelope(new double[] { 5, 5 }, new double[] { 10, 10 }, false)));
    assertEquals(new Envelope(new double[] { 2, 5 }, new double[] { 12, 10 }, false), EnvelopeUtilities.concat(
        new Envelope(new double[] { 5, 5 }, new double[] { 10, 10 }, false),
