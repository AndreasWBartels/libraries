...
public interface IPackageQueryExecutor {
  ...
  IPackageSearchResult query(
      ICanceler canceler,
      IHttpConnectionDescription description,
      IPackageSearchCondition condition)
      throws CanceledException,
      IOException;

  IPackageSearchResult query(ICanceler canceler, IHttpConnectionDescription description, String identifier)
      throws CanceledException,
      IOException;
